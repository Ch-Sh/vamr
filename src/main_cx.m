...
for f = 1:199
    ...
    [R,t,keypoints2D_matched_swap,~] = estimatePoseRANSAC(keypoints2D_matched_swap,landmarks3D_matched,K);
    %keypoints2D_matched = [keypoints2D_matched_swap(:,1),keypoints2D_matched_swap(:,2)];
