function [R_C_W, t_C_W,inlier_mask,max_num_inliers_history] = ransacLocalization(...
    new_state,query_keypoints, p_W_landmarks, K)
...
%   matched keypoints (!!!), 0 if the match is an outlier, 1 otherwise.
    ...
    matched_query_keypoints = query_keypoints(:, new_state > 0);
    corresponding_matches = new_state(new_state > 0);
